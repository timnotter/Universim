...
public abstract class Planet extends Trabant{
	...
	public Planet(double size, double mass, double apoapsis, double periapsis, boolean habitability, Star parentStar) {
		super(size, mass, apoapsis, periapsis, parentStar);
		this.habitability = habitability;
	}
